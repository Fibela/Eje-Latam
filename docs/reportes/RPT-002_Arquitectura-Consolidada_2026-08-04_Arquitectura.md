...
| PA-97 | `componerSucesos` (RPT-048 §4) no lee `hayMas` todavia | 🟡 Abierto — RPT-049 §7. **Con cifra desde RPT-084 §8:** una consulta real devolvio **1 038 208 bytes** con `hayMas: true`. Un megabyte que la consola no sabe paginar |
