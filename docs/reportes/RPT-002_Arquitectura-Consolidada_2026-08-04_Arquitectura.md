...
| PA-53 | Lectura de la frase de paso sin eco en pantalla | 🔴 **Abierto, critico** — RPT-026 §5. **Escalado el 31-ago-2026: dejo de ser teorico.** Una frase de paso real se tecleo en claro sobre la pantalla y quedo en el registro de la sesion; hubo que darla por comprometida y rotar la identidad entera del sensor de la VM de PA-78. El aviso que la herramienta imprime describia el riesgo con exactitud y no lo evito: **avisar no es una contramedida**. Dos puntos salieron de ese mismo minuto — PA-144 (el orden que hizo la exposicion inutil ademas de peligrosa) y PA-146 (que la rotacion consiguiente no tiene procedimiento) |
